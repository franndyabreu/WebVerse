...
test.serial("Metric#create -existing", async t => {
  ...
  t.true(AgentStub.findOne.calledWith(uuidArgs), "FindOne called with specified args");
});
test.serial("Metric#findByUuid", async t => {
  ...
  t.true(MetricStub.findByAgentUuid.calledOnce, "findByAgentUuid should be called Once");
  t.true(MetricStub.findByAgentUuid.calledWith(agentUUID), "findByAgentUuid should be called with specified params");
...
//# sourceMappingURL=/Users/franndyabreu/Desktop/Platzi-Verse/platziverse-db/node_modules/.cache/ava/fb8fa017fe4860da5c1b2539cbe44cfd.js.map