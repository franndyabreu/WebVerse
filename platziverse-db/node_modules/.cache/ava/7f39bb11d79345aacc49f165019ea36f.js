...
const responseUuid = metricFixtures.findByAgentUuid(uuid);
const typeAgentResponse = metricFixtures.findByTypeAgentUuid(type, uuid);
let sandbox = null;
let db = null;
let AgentStub = null;
...
test.serial("Metric#create -existing", async t => {
  ...
  console.log(metric);
  t.true(AgentStub.findOne.called, "FindOne called"); // t.true(MetricStub.create.called, "Should be called");
...
test.serial("Metric#findByUuid", async t => {
  ...
  t.deepEqual(metric, metricFixtures.findByAgentUuid(uuid), "Should be the same."); //   t.true(MetricStub.findByAgentUuid.called, "FindByAgentUuid should be called");
});
...
//# sourceMappingURL=/Users/franndyabreu/Desktop/Platzi-Verse/platziverse-db/node_modules/.cache/ava/7f39bb11d79345aacc49f165019ea36f.js.map