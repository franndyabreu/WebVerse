...
test.beforeEach(async () => {
  ...
  }).returns(Promise.resolve(agentFixtures.findByUuid(uuid))); //Model CreateMetric stub
  ...
  MetricStub.findByTypeAgentUuid.withArgs(typeAgentUuidArgs).returns(Promise.resolve(metricFixtures.findByTypeAgentUuid(type, uuid))); //Modell findByAgentUuid stub

  MetricStub.findByAgentUuid = sandbox.stub();
  MetricStub.findByAgentUuid.withArgs(findByAgentUuidArgs).returns(Promise.resolve(metricFixtures.findByAgentUuid(uuid))); // Model findAll Stub
...
//# sourceMappingURL=/Users/franndyabreu/Desktop/Platzi-Verse/platziverse-db/node_modules/.cache/ava/bc4cecae05d1a452bbdb10ac8b2525aa.js.map