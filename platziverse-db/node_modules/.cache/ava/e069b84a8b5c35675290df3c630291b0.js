...
test.serial("Metric#findByUuid", async t => {
  let metric = await db.Metric.findByAgentUuid("xxx");
  ...
  t.deepEqual(metric, metricFixtures.findByAgentUuid(agentUUID), "Should be the same."); //   t.true(MetricStub.findByAgentUuid.called, "FindByAgentUuid should be called");
});
...
//# sourceMappingURL=/Users/franndyabreu/Desktop/Platzi-Verse/platziverse-db/node_modules/.cache/ava/e069b84a8b5c35675290df3c630291b0.js.map