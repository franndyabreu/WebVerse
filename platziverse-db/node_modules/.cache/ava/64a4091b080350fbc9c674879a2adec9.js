...
test.beforeEach(async () => {
  ...
  AgentStub.findOne.withArgs(uuidArgs).returns(Promise.resolve(agentFixtures.findByUuid(uuidArgs))); //Model CreateMetric stub
...
test.serial("Metric#create - agent exists", async t => {
  let metric = await db.Metric.create(uuidArgs, newMetric); // t.true(AgentStub.findOne.called, "findOne should be called on model");
  ...
  t.true(MetricStub.create.calledWith(uuidArgs, newMetric), "create should be called with specified args");
...
//# sourceMappingURL=/Users/franndyabreu/Desktop/Platzi-Verse/platziverse-db/node_modules/.cache/ava/64a4091b080350fbc9c674879a2adec9.js.map