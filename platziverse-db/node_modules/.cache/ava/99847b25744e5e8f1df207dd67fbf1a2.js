...
test.beforeEach(async () => {
  ...
  MetricStub.findByTypeAgentUuid.withArgs(type, typeAgentUuidArgs).returns(Promise.resolve(metricFixtures.findByTypeAgentUuid(type, uuidArgs))); //Modell findByAgentUuid stub
...
test.serial("Metric#FindByTypeAgentUuid", async t => {
  let metric = await db.Metric.findByTypeAgentUuid(type, typeAgentUuidArgs);
  t.deepEqual(metric, metricFixtures.findByTypeAgentUuid(type, uuidArgs));
});
//# sourceMappingURL=/Users/franndyabreu/Desktop/Platzi-Verse/platziverse-db/node_modules/.cache/ava/99847b25744e5e8f1df207dd67fbf1a2.js.map