...
test.serial("Metric#findByUuid", async t => {
  ...
  t.true(db.Metric.findByAgentUuid.called, "findByAgentUuid should be called");
  t.true(db.Metric.findByAgentUuid.calledOnce, "findByAgentUuid should be called Once");
  t.true(db.Metric.findByAgentUuid.calledWith(uuidArgs), "findByAgentUuid should be called with specified params");
...
//# sourceMappingURL=/Users/franndyabreu/Desktop/Platzi-Verse/platziverse-db/node_modules/.cache/ava/9ce1d61cc89a265b273950ef3e4a717c.js.map