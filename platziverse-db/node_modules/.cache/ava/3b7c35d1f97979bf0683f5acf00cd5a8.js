...
test.beforeEach(async () => {
  ...
  AgentStub.findOne.withArgs(uuidArgs).returns(Promise.resolve(agentFixtures.findByUuid(uuid))); //Model Update Stub
...
test.serial("Agent#createOrUpdate -existing obj", async t => {
  ...
  t.true(AgentStub.update.calledWith(single, uuid), "Update called with specified params");
  t.deepEqual(agent, single, "Agent should be the same");
});
//# sourceMappingURL=/Users/franndyabreu/Desktop/Platzi-Verse/platziverse-db/node_modules/.cache/ava/3b7c35d1f97979bf0683f5acf00cd5a8.js.map